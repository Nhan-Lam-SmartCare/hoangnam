    ...
    return (
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between w-full relative px-3.5 py-3 bg-slate-100/60 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/90 rounded-xl">
                    <div className="flex flex-col items-start gap-1">
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Ngày kích hoạt</div>
                        <div className="flex items-center gap-1.5 text-slate-900 dark:text-slate-100 font-extrabold text-xs sm:text-[13px]">
                    ...
                    <div className="flex-1 flex items-center justify-center px-4 relative">
                        <div className="w-full border-t border-dashed border-slate-300 dark:border-slate-700 relative">
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 px-2.5 py-0.5 rounded-full text-[9px] font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest shrink-0">
                                {card.warranty_period_months}T
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col items-end gap-1">
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Ngày hết hạn</div>
                        <div className="flex items-center gap-1.5 text-slate-900 dark:text-slate-100 font-extrabold text-xs sm:text-[13px]">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs font-bold">
                        <div className="flex items-center gap-1.5">
                            <span className="text-slate-400 dark:text-slate-500 font-semibold uppercase tracking-wider text-[10px]">Hiệu lực:</span>
                            <span className={`text-[11px] font-extrabold uppercase tracking-wide px-2 py-0.5 rounded-md ${
                                card.status === "voided" 
                                ...
                                {card.status === "voided" 
                                    ...
                                    : daysRemaining === 0 
                                        ? "Đã hết hạn" 
                                        : daysRemaining <= 30
                                            ? `Hạn sắp hết (Còn ${daysRemaining} ngày)`
                                            : `An toàn (Còn ${daysRemaining} ngày)`
                                }
                            </span>
                        </div>
                    ...
                    <div className="h-2 w-full bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden border border-slate-200/20 dark:border-slate-700/50">
                        <div
                ...
                <div className="flex items-center gap-2 border-t border-slate-100 dark:border-slate-800/60 pt-4 w-full">
                    <button
                        onClick={() => onPrint(card)}
                        className="flex-1 h-11 px-4 rounded-xl bg-slate-100 hover:bg-slate-200/80 dark:bg-slate-800/80 dark:hover:bg-slate-700/80 text-slate-700 dark:text-slate-200 text-xs sm:text-[13px] font-bold flex items-center justify-center gap-2 transition-all border border-slate-200/40 dark:border-slate-700/60 shadow-sm active:scale-95"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 h-11 px-4 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs sm:text-[13px] font-bold flex items-center justify-center gap-2 transition-all border border-emerald-500/20 dark:border-emerald-400/30 shadow-sm active:scale-95 disabled:opacity-40"
                    >
                    ...
                    <div className="relative w-11 shrink-0">
                        <button
                            ...
                            className="h-11 w-11 rounded-xl flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-slate-650 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-all border border-slate-200/40 dark:border-slate-700/50 active:scale-95 shadow-sm"
                        >
